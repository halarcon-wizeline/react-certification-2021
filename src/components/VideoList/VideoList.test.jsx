...
describe('Render VideoList', () => {
  ...
  test('It should render ALL the elements', () => {
    ...
    expect(screen.getByText(filteredCollection.items[0].snippet.title)).toBeInTheDocument();
    expect(screen.getByText(filteredCollection.items[0].snippet.description)).toBeInTheDocument();

    expect(screen.getByText(filteredCollection.items[1].snippet.title)).toBeInTheDocument();
    expect(screen.getByText(filteredCollection.items[1].snippet.description)).toBeInTheDocument();
  });
  ...
  test('It should remove elements without a videoId', () => {
    ...
    expect(screen.queryByText(unfilteredCollection.items[0].snippet.title)).not.toBeInTheDocument();
    expect(screen.queryByText(unfilteredCollection.items[0].snippet.description)).not.toBeInTheDocument();

    expect(screen.getByText(unfilteredCollection.items[1].snippet.title)).toBeInTheDocument();
    expect(screen.getByText(unfilteredCollection.items[1].snippet.description)).toBeInTheDocument();
  });
});
